...
| Claim                                     | Code evidence                                                                                                                                                                                                                                                              |
| ----------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Both providers share one core contract    | [`CardanoDataProvider`](https://github.com/verbotenj/cardano-raw-sdk/blob/c8ce8bff6d90810d8a2cad74dc87619c240c91ad/src/types/providers.ts#L19-L37) defines health, balance, UTxO, slot, submission, and confirmation operations.                                           |
| Configuration accepts either provider     | [`ChainProviderConfig`](https://github.com/verbotenj/cardano-raw-sdk/blob/c8ce8bff6d90810d8a2cad74dc87619c240c91ad/src/types/providers.ts#L39-L52) is an `iagon`/`demeter` TypeScript union.                                                                               |
| The SDK performs the wiring               | [`createInstance()`](https://github.com/verbotenj/cardano-raw-sdk/blob/c8ce8bff6d90810d8a2cad74dc87619c240c91ad/src/FireblocksCardanoRawSDK.ts#L243-L316) selects `IagonApiService` or `DemeterBlockfrostProvider`.                                                        |
| IAGON remains supported                   | [`IagonApiService`](https://github.com/verbotenj/cardano-raw-sdk/blob/c8ce8bff6d90810d8a2cad74dc87619c240c91ad/src/services/iagon.api.service.ts#L86-L104) implements the shared contract and retains the extended SDK feature set.                                        |
| Demeter is a real provider implementation | [`DemeterBlockfrostProvider`](https://github.com/verbotenj/cardano-raw-sdk/blob/c8ce8bff6d90810d8a2cad74dc87619c240c91ad/src/services/demeter-blockfrost.provider.ts#L75-L126) implements the contract, validates the resource URL, and authenticates with `dmtr-api-key`. |
...
| ------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Source             | The dependency is pinned to the [Demeter-enabled SDK revision](https://github.com/verbotenj/cardano-raw-sdk/commit/c8ce8bff6d90810d8a2cad74dc87619c240c91ad).                                                                                                                                                                                                                                                                |
