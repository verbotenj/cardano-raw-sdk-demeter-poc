...
| Claim                                     | Code evidence                                                                                                                                                                                                                                                              |
| ----------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Both providers share one core contract    | [`CardanoDataProvider`](https://github.com/verbotenj/cardano-raw-sdk/blob/fd09904a22b1515fba385b970b4d669d67321bb3/src/types/providers.ts#L19-L37) defines health, balance, UTxO, slot, submission, and confirmation operations.                                           |
| Configuration accepts either provider     | [`ChainProviderConfig`](https://github.com/verbotenj/cardano-raw-sdk/blob/fd09904a22b1515fba385b970b4d669d67321bb3/src/types/providers.ts#L39-L52) is an `iagon`/`demeter` TypeScript union.                                                                               |
| The SDK performs the wiring               | [`createInstance()`](https://github.com/verbotenj/cardano-raw-sdk/blob/fd09904a22b1515fba385b970b4d669d67321bb3/src/FireblocksCardanoRawSDK.ts#L243-L316) selects `IagonApiService` or `DemeterBlockfrostProvider`.                                                        |
| IAGON remains supported                   | [`IagonApiService`](https://github.com/verbotenj/cardano-raw-sdk/blob/fd09904a22b1515fba385b970b4d669d67321bb3/src/services/iagon.api.service.ts#L86-L104) implements the shared contract and retains the extended SDK feature set.                                        |
| Demeter is a real provider implementation | [`DemeterBlockfrostProvider`](https://github.com/verbotenj/cardano-raw-sdk/blob/fd09904a22b1515fba385b970b4d669d67321bb3/src/services/demeter-blockfrost.provider.ts#L75-L126) implements the contract, validates the resource URL, and authenticates with `dmtr-api-key`. |
...
| ------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Source             | The dependency is pinned to the [Demeter-enabled SDK revision](https://github.com/verbotenj/cardano-raw-sdk/commit/fd09904a22b1515fba385b970b4d669d67321bb3).                                                                                                                                                                                                                                                                |
